...
import serviceBusinessIconUrl from "../../assets/service-icon-business.webp";
import serviceCustomTripIconUrl from "../../assets/service-icon-custom-trip.webp";
...
export const serviceImages = {
  ...
  sapa: serviceLongDistanceUrl,
  haGiang: serviceBusinessUrl,
...
export const fleetImages = {
  ...
  limoGreen: vehicleLimoPrimeUrl,
};

export const whyIconImages = {
...
export const cruiseImages = {
  ...
  heritageBinhChuan: cruiseHeritageBinhChuanUrl,
  stellarSeas: cruiseStellarSeasUrl,
  eraCruises: cruiseEraCruisesUrl,
  seamlessTransfer: cruiseSeamlessTransferUrl,
  expCabin: cruiseExpCabinUrl,
